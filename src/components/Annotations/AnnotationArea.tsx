...
interface Props {
  ...
  handleResize: (e: any, direction: any, ref: any, d: any) => void;
}
...
const AnnotationArea = ({
  ...
  return (
    <Resizable
      ...
      minWidth={600}
      minHeight={200}
      className={`w-full h-full mb-4 border border-gray-200 rounded-lg  dark:border-gray-600 ${
    ...
    >
      <div className="h-full flex flex-col justify-between">
        ...
        <div
          className={`child-div px-4 mx-2 py-2 h-full rounded-lg ${
        ...
        >
          ...
          <textarea
            ...
            className="w-full h-full px-0 border-0 bg-transparent focus:ring-0 dark:text-white dark:placeholder-gray-400"
